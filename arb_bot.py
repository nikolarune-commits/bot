...
ENTRY_MIN_PRICE    = 0.32     # Skip if market has priced out the move
ENTRY_MAX_PRICE    = 0.75     # Skip near-certainties (low payout)
WINDOW_MIN_AGE     = 20       # Don't trade in the first 20s (market still adjusting)
WINDOW_MAX_AGE     = 200      # Don't trade after 3.3 min (move already priced in)
CONFIDENCE_MIN     = 0.50     # ~3.5/7 minimum score — moderate signal required
